...
import { readFileAsBuffer, resolveTilePath, scanDemFolder, } from "./scan-dem-folder.js";
 ...
 */
export async function runGenerateManifest(options) {
    ...
    if (failed)
        log(`Skipped ${failed} file(s) due to errors.`);
